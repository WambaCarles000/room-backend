...
export class Migrations1771270002634 implements MigrationInterface {
    name = 'Migrations1771270002634'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "listing_image" ADD "id" SERIAL NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "contact_request" ADD "id" SERIAL NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "listing_image" ADD CONSTRAINT "FK_b0d09774d741ddf347b214b95e0" FOREIGN KEY ("listingId") REFERENCES "listings"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "favorite" ADD CONSTRAINT "FK_fc0de60d650b005296eabb57a3f" FOREIGN KEY ("listingId") REFERENCES "listings"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "contact_request" ADD CONSTRAINT "FK_ec79054d03b60610e1cccb1675f" FOREIGN KEY ("listingId") REFERENCES "listings"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
